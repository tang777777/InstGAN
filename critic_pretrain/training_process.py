...
class FACGAN(nn.Module):
    ...
    def __init__(self, data, latent_dim_size=512, lr_critic=1e-5, device='cuda:0', RL_Flag='Pretrain'):
    ...
    def train_n(self, training_data, train_loader, max_step=60000, evaluate_every=100):
        ...
        for step in range(max_step):
            ...
            if self.RL_Flag =='DRD2':
                critic_loss = self.critic_pretrain(tokenized_smiles, drd2_values)
