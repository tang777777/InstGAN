...
def evaluation(generated_smiles, training_smiles, log_file='logs/training_log.txt'):
    ...
    return validity, uniqueness, novelty, total, diversity, novel_mean_qed, novel_mean_solubility, novel_mean_sa
...
# Benchmark Datasets:
    ...
    - QM9 dataset:
        - Download: https://deepchemdata.s3-us-west-1.amazonaws.com/datasets/qm9.csv
        - Description: contains 134K small molecules (only use the column of smiles)

    - ZINC dataset:
        - Download: https://github.com/chainer/chainer-chemistry/blob/master/chainer_chemistry/datasets/zinc.py
        - Description: contains 250K molecules 

    - CHEMBL dataset: 
        - Download: https://github.com/BenevolentAI/guacamol
        - Description: contains 127K drug-like SMILES strings

    ### average length of QM9 < ZINC < CHEMBEL ###
